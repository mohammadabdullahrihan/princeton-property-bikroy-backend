...
describe('Property Endpoints', () => {
  ...
  const sampleProperty = {
    ...
    description: 'A beautiful place that meets the minimum length requirement of fifty characters or more for validation purposes.',
    price: 5000000,
    category: 'buy',
  ...
  describe('GET /api/properties', () => {
    ...
    it('should get all properties', async () => {
      ...
      expect(res.body.data.properties[0].title).toBe(sampleProperty.title);
    });
  });
